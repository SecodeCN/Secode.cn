...
let timelineData = [
    { title: '初见心跳', date: '2025-02-25', text: '第一次遇见，风里都带着心跳的回声。' },
    { title: '初情人节', date: '2025-05-20', text: '餐桌两端那一眼，比所有布景更像心动的注脚。' },
    { title: '端午暖意', date: '2025-05-31', text: '父母的笑声把我们悄悄靠近的温度包住。' },
    { title: '第一次到访', date: '2025-06-02', text: '玄关那双鞋印，像给我的心盖了枚温柔邮戳。' },
    { title: '奔向门口', date: '2025-06-21', text: '电话响时我奔向门口的慌张，成了甜的记忆。' },
    { title: '星光晚风', date: '2025-06-28', text: '晚风裹着星光，你的温度比夜更让人沉醉。' },
    { title: '同眠之夜', date: '2025-06-29', text: '那夜连呼吸都放轻，怕惊扰这份安稳。' },
    { title: '牵手纪念', date: '2025-07-12', text: '指尖扣住的瞬间，未来开始具象。' },
    { title: '相拥入夜', date: '2025-07-24', text: '呼吸融进同一片夜色，心又靠近一层。' },
    { title: '回家祝福', date: '2025-08-03', text: '餐桌上父母的微笑盛满对我们的祝福。' },
    { title: '此刻', date: new Date().toISOString().slice(0, 10), text: '我准备好把余生缓慢而坚定地交给你。' }
];
